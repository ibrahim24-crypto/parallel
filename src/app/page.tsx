  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-950 via-black to-neutral-900 text-white overflow-x-hidden">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center gap-3 group cursor-pointer">
            <div className="w-8 h-8 bg-gradient-to-br from-green-400 to-green-600 rounded-lg flex items-center justify-center text-white font-black text-lg transform group-hover:scale-110 group-hover:rotate-12 transition duration-300">
              P
            </div>
            <span className="text-xl font-black text-green-400 group-hover:text-green-300 transition duration-300">PARALLEL</span>
          </div>
          ...
          <button className="group relative px-6 py-2 bg-gradient-to-r from-green-500 to-green-600 rounded-lg font-bold text-sm overflow-hidden transition duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-green-500/50 active:scale-95">
            <span className="relative z-10">Get Started</span>
            <div className="absolute inset-0 bg-gradient-to-r from-green-600 to-green-700 opacity-0 group-hover:opacity-100 transition duration-300"></div>
          </button>
        </div>
      </nav>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-20 left-10 w-80 h-80 bg-green-500/20 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '4s', transform: `translateY(${scrollY * 0.3}px)` }}></div>
        <div className="absolute bottom-40 right-10 w-80 h-80 bg-green-600/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s', animationDuration: '5s', transform: `translateY(${scrollY * -0.2}px)` }}></div>
        <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-green-500/10 rounded-full blur-3xl" style={{ animationDuration: '6s', transform: `translate(-50%, calc(-50% + ${scrollY * 0.5}px))` }}></div>
      </div>
      ...
      <section id="home" className="min-h-screen flex items-center justify-center pt-20 relative px-6">
        <div className="text-center space-y-8 max-w-4xl animate-fade-in-up">
          <div className="relative mb-8">
            <div className="absolute inset-0 bg-gradient-to-r from-green-500 to-green-600 rounded-full blur-3xl opacity-30 animate-pulse-glow"></div>
            <div className="relative flex justify-center mb-6">
              <div className="w-24 h-24 bg-gradient-to-br from-green-500 to-green-600 rounded-3xl flex items-center justify-center text-5xl font-black animate-float shadow-2xl shadow-green-500/50">
                P
              </div>
            </div>
          </div>
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-2xl mx-auto leading-relaxed font-light">
            Advanced manufacturing solutions for <span className="text-green-400 font-semibold">3D Printing</span>, <span className="text-green-400 font-semibold">Laser Cutting</span> & <span className="text-green-400 font-semibold">CNC Machining</span>
          </p>
          
          <div className="flex gap-4 justify-center pt-8 flex-wrap animate-fade-in-up stagger-3">
            <button className="group relative px-8 py-4 bg-gradient-to-r from-green-500 to-green-600 rounded-xl font-bold text-lg overflow-hidden transition duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-green-500/50 active:scale-95">
              <span className="relative z-10">Get Started</span>
              <div className="absolute inset-0 bg-gradient-to-r from-green-600 to-green-700 opacity-0 group-hover:opacity-100 transition duration-300"></div>
            </button>
        ...
        <div className="max-w-6xl mx-auto w-full">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={i}
                className="group bg-gradient-to-br from-green-500/15 to-green-600/15 border border-green-500/30 rounded-2xl overflow-hidden hover:border-green-400 transition duration-500 hover-lift animate-scale-in stagger-1 cursor-pointer backdrop-blur-sm"
                style={{ animationDelay: `${i * 0.2}s` }}
              >
                <div className="h-32 bg-gradient-to-br from-green-500/20 to-green-600/20 group-hover:from-green-500/40 group-hover:to-green-600/40 transition duration-500 flex items-center justify-center text-7xl transform group-hover:scale-110 duration-500">
                  {service.icon}
                </div>
                <div className="p-8 space-y-4">
                  <h3 className="text-2xl font-black group-hover:text-green-400 transition duration-300">{service.title}</h3>
                  <p className="text-gray-400 group-hover:text-gray-300 transition duration-300 leading-relaxed">
                    {service.description}
                  </p>
                  <div className="pt-4 space-y-2">
                    {service.features.map((feature, j) => (
                      <div key={j} className="text-sm text-gray-400 flex items-center gap-3 transform transition duration-300 group-hover:translate-x-1 group-hover:text-green-300">
                        <span className="w-2 h-2 bg-green-500 rounded-full group-hover:bg-green-400 transition"></span>
                        {feature}
                      </div>
                    ))}
                  </div>
        ...
        <div className="max-w-6xl mx-auto w-full">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="group bg-gradient-to-br from-green-500/15 to-green-900/20 border border-green-500/30 rounded-2xl overflow-hidden hover:border-green-400 transition duration-500 hover-lift animate-scale-in stagger-1 backdrop-blur-sm"
                style={{ animationDelay: `${i * 0.1}s` }}
              >
                <div className="aspect-square bg-gradient-to-br from-green-500/20 to-green-600/20 group-hover:from-green-500/40 group-hover:to-green-600/40 transition duration-500 flex items-center justify-center text-8xl transform group-hover:scale-125 duration-500 relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-green-500/0 via-green-500/20 to-green-500/0 transform group-hover:-translate-x-full duration-500"></div>
                  {project.image}
                </div>
                <div className="p-6 space-y-3">
                  <span className="inline-block px-4 py-1 bg-green-500/30 text-green-300 rounded-full text-xs font-black uppercase tracking-widest">
                    {project.category}
                  </span>
                  <h3 className="text-xl font-black group-hover:text-green-400 transition duration-300">
                    {project.title}
                  </h3>
                </div>
              </div>
          ...
          <div className="space-y-8 animate-slide-in-left">
            ...
            <div className="grid grid-cols-2 gap-6 pt-8">
              {[
                ...
                <div key={i} className="p-4 bg-gradient-to-br from-green-500/20 to-green-600/20 border border-green-500/30 rounded-xl hover:border-green-400 transition duration-300 hover:bg-green-500/30 animate-scale-in stagger-1 backdrop-blur-sm" style={{ animationDelay: `${i * 0.1}s` }}>
            ...
            {[
              ...
              <div key={i} className="p-6 bg-gradient-to-r from-green-500/10 to-green-600/10 border border-green-500/30 rounded-xl hover:border-green-400 hover:from-green-500/20 hover:to-green-600/20 transition duration-300 transform hover:translate-x-2 animate-fade-in-up stagger-1 backdrop-blur-sm group cursor-pointer" style={{ animationDelay: `${i * 0.1}s` }}>
                <div className="flex gap-4 group-hover:gap-6 transition duration-300">
                  <div className="text-3xl flex-shrink-0 transform group-hover:scale-125 group-hover:text-green-400 transition duration-300">{item.icon}</div>
                  <div>
                    <h4 className="font-black text-lg mb-1 group-hover:text-green-400 transition duration-300">{item.title}</h4>
      ...
      <section id="contact" className="min-h-screen flex items-center py-20 relative px-6">
        <div className="max-w-6xl mx-auto w-full text-center space-y-12">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in-up stagger-2">
            <a href="mailto:ibrahimezzine09@gmail.com" className="group relative px-8 py-4 bg-gradient-to-r from-green-500 to-green-600 rounded-xl font-bold text-lg overflow-hidden transition duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-green-500/50 active:scale-95">
          ...
          <div className="grid md:grid-cols-3 gap-6 pt-12">
            {[
              ...
              <a 
                ...
                className="p-8 bg-gradient-to-br from-green-500/15 to-green-600/15 border border-green-500/30 rounded-xl hover:border-green-400 hover:from-green-500/25 hover:to-green-600/25 transition duration-300 animate-fade-in-up stagger-1 backdrop-blur-sm group cursor-pointer" 
                style={{ animationDelay: `${i * 0.1}s` }}
              >
                ...
                <div className="font-black text-lg text-green-400 group-hover:text-green-300 transition duration-300">{contact.value}</div>
              </a>
            ))}
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div>
              <div className="text-green-500 font-black text-2xl mb-4 flex items-center gap-3">
                <div className="w-8 h-8 bg-green-500 rounded-2xl animate-pulse"></div>
                PARALLEL
              </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400 text-sm">
                <li><a href="#" className="hover:text-green-400 transition duration-300 transform hover:translate-x-1 inline-block">3D Printing</a></li>
                <li><a href="#" className="hover:text-green-400 transition duration-300 transform hover:translate-x-1 inline-block">Laser Cutting</a></li>
                <li><a href="#" className="hover:text-green-400 transition duration-300 transform hover:translate-x-1 inline-block">CNC Machining</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-black mb-6 uppercase tracking-widest text-sm text-green-400">Company</h4>
              <ul className="space-y-3 text-gray-400 text-sm">
                <li><a href="#" className="hover:text-green-400 transition duration-300 transform hover:translate-x-1 inline-block">About</a></li>
                <li><a href="#" className="hover:text-green-400 transition duration-300 transform hover:translate-x-1 inline-block">Portfolio</a></li>
                <li><a href="#" className="hover:text-green-400 transition duration-300 transform hover:translate-x-1 inline-block">Contact</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-black mb-6 uppercase tracking-widest text-sm text-green-400">Social</h4>
              <ul className="space-y-3 text-gray-400 text-sm">
                <li><a href="#" className="hover:text-green-400 transition duration-300 transform hover:translate-x-1 inline-block">Twitter</a></li>
                <li><a href="#" className="hover:text-green-400 transition duration-300 transform hover:translate-x-1 inline-block">LinkedIn</a></li>
                <li><a href="#" className="hover:text-green-400 transition duration-300 transform hover:translate-x-1 inline-block">Instagram</a></li>
              </ul>
            </div>
          </div>
